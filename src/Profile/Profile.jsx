    ...
    return (
        <div className="w-full h-full relative">
            ...
            <div className="flex flex-row w-full justify-center min-h-[calc(100vh-3.5rem)]">
                <div className={`flex flex-row lg:justify-around justify-around xl:w-3/4 w-full lg:pt-0 lg:h-5/6 mt-12 mb-12 h-auto md:px-20 px-6 font-main sm:flex-nowrap flex-wrap`}> 
                    ...
                    {selected == 1 && <main className="lg:w-2/3 max-w-fit mt-16 flex flex-col lg:pt-24 pt-8 min-w-fit">

...
export function AboutUs() {
    return (
        ...
        <Helmet>
            ...
            <div className="xl:w-3/4 lg:w-full lg:pt-0 sm:bottom-14 sm:mb-14 bottom-28 flex flex-col md:px-20 px-8 font-main">
                <h1 className=" font-bold text-purple1 text-5xl xl:pt-32 pt-24">¿Quiénes somos?</h1>
                <div className="flex lg:flex-row flex-col w-full">
                    <div className="flex flex-col lg:w-1/2 w-full h-auto xl:pt-28 pt-4">

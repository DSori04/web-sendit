...
export function AboutUs() {
    return (
        <>
            ...
            <div className="w-3/4 lg:absolute lg:pt-0 pt-16 top-16 sm:bottom-14 bottom-28 flex flex-col md:px-20 px-6 font-main">
                ...
                <div className="flex lg:flex-row flex-col w-full">
                    <div className="flex flex-col lg:w-1/2 w-full h-auto">
                        <p className="font-main text-black lg:text-2xl text-2xl lg:mt-28 xl:mt-36 mt-10 tracking-wide lg:leading-[3.5rem] leading-10 lg:text-right">
                    ...
                    <div className="flex-col flex lg:w-1/2 h-auto lg:mt-10">
                        ...
                        <div className="text-right text-main lg:mt-10 mt-5 flex flex-row justify-end">
                            <div className="w-3/5 pr-4 pt-3 text-md max-h-fit">

...
export function Home() {
    ...
    return (
        <>
            <Navbar />
            <div className="absolute top-16 bg-white w-full h-max flex flex-col">
                <div id="text-main" className="flex flex-row w-9/12 justify-around sm:ml-32 lg:mt-12 mt-4 flex-wrap-reverse">
                    <div id="text-content" className="flex flex-col w-5/12 mt-32">
                        <div id="text" className="flex flex-col w-full h-max lg:tracking-wider tracking-wide font-bold lg:text-right text-center xl:test-5xl lg:text-4xl sm:text-3xl text-2xl font-main">

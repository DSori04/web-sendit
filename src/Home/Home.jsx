...
export function Home() {
    ...
    return (
        <>
            <Navbar />
            <div className="pt-16 bg-white lg:w-3/4 w-full lg:absolute lg:left-52 h-max flex flex-col md:px-20 px-6">
                ...
                <div id="counters" className="lg:w-[70%] lg:ml-[20%] w-full h-max flex justify-around text-center lg:mt-36 md:mt-12 mt-5 lg:scale-100 scale-75">

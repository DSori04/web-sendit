            ...
            <div className="absolute top-16 sm:bottom-14 bottom-28 bg-white w-full h-9/12 flex flex-col">
                <div id="text-main" className="flex flex-row w-9/12 justify-around sm:ml-32 lg:mt-12 mt-4 flex-wrap-reverse">
                    <div id="text-content" className="flex flex-col w-5/12 mt-32">
                        <div id="text" className="w-full h-1/2 tracking-wider font-bold lg:text-right text-center lg:text-4xl text-3xl font-main">Nunca hemos <br></br> estado tan <span className="text-purple1">cerca</span></div>

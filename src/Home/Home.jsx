                ...
                <div id="text-main" className="flex flex-row w-9/12 justify-around ml-48 mt-12 flex-wrap-reverse">
                    <div id="text-content" className="flex flex-col w-5/12 mt-32">
                        ...
                        <div id="conocenos" className="w-full mt-5 flex flex-row sm:justify-around justify-center">
                            ...
                            <div className="flex-end w-40 font-main mt-4 lg:m-0 drop-shadow-lg border-purple1 hover:scale-105 font-semibold text-xl py-2 border-2 text-white bg-purple1 rounded-full text-center cursor-pointer">

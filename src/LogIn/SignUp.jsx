...
export function SignUp(){
    ...
    return (
        <>
            <Navbar />
            <div className="xl:w-3/4 xl:ml-[15%] lg:absolute lg:pt-20 pt-16 top-16 sm:bottom-14 bottom-28 w-full flex flex-col md:px-20 px-6 font-main lg:min-h-0 min-h-screen select-none">
